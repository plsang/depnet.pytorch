...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'train_label',
        type=str,
        help='path to the h5file containing the labels')
    parser.add_argument(
        'val_label',
        type=str,
        help='path to the h5file containing the labels')
    ...
    parser.add_argument(
        ...
        type=int,
        default=128,
        help='batch size (there will be x seq_per_img sentences)')
    parser.add_argument(
        '--learning_rate',
        type=float,
        default=1e-4,
    ...
    parser.add_argument('--val_step', type=int, default=1,
                        help='val step, default=1 (every epoch)')
    ...
    for epoch in range(opt.num_epochs):
        ...
        if epoch % opt.val_step == 0:
            ...
            if loss < best_loss:
                logger.info(
                    'Found new best score: %.7f, previous score: %.7f',
                    loss,
                    best_loss)
                best_loss = loss
                best_epoch = epoch
                ...
                logger.info(
                    'Current score: %.7f, best score is %.7f @ epoch %d',
                    loss,
                    best_loss,
                    best_epoch)
